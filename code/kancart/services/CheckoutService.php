...
class CheckoutService extends BaseService {
    ...
    public function getReviewOrder() {
        ...
        $order['selected_shipping_method_id'] = $this->selectShippingMethod();
        return $order;
    }
    ...
    public function getShippingAddress() {
        ...
        if ($sendTo) {
            ...
            $this->setZone($addr['country_id'], $addr['zone_id']);
            return $addr;
        }
        return array();
    }
    ...
    public function getBillingAddress() {
        ...
        if ($billto) {
            ...
            if (!$this->cart->hasShipping()) {
                $this->setZone($billingAddress['country_id'], $billingAddress['zone_id']);
            }
